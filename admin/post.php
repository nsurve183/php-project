<?php include "header.php"; ?>
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading">Welcome <?php echo $_SESSION['fname']?> This Is Your All Posts</h1>
              </div>
              <div class="col-md-2">
              ...
              <div class="col-md-12">
                ...
                if($_SESSION['userrole'] == 1){
                    // if user is admin it can see all the post data of all user
                    $sql = "SELECT * FROM post 
                    LEFT JOIN category on post.category = category.category_id
                    LEFT JOIN user on post.author = user.user_id
                 ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
                }elseif($_SESSION['userrole'] == 0){
                    // if user is normal user it can see only the post data of self
                    $sql = "SELECT * FROM post 
                     LEFT JOIN category on post.category = category.category_id
                    LEFT JOIN user on post.author = user.user_id
                ...
                ?>
                  ...
                  if(mysqli_num_rows($result1)){
                      ...
                      if($page > 1){
                          echo '<li><a <a href="./post.php?page='.($page - 1).'">Prev</a></li>';
                      }
