            ...
            <div class="col-md-8">
                ...
                ?>
                  ...
                  <?php  
                        ...
                        WHERE post.title LIKE '%$search_term%' OR category_name LIKE '%$search_term%'
                    ...
                    $sql1 = "SELECT * FROM post WHERE post.title LIKE '%{$search_term}%'";
                     ...
                     $result1 = mysqli_query($con, $sql1) or die("Pegination of category Post Query Failed");
                    ...
                    echo "<ul class='pagination admin-pagination'>";
                      ...
                      if($page > 1){
                        echo '<li><a <a href="./index.php?search='.$search_term.'&page='.($page - 1).'">Prev</a></li>';
                    }
